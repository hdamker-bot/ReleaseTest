...
<a href="https://github.com/camaraproject/ReleaseTest/graphs/contributors" title="Contributors"><img src="https://img.shields.io/github/contributors/camaraproject/ReleaseTest?style=plastic"></a>
<a href="https://github.com/camaraproject/ReleaseTest" title="Repo Size"><img src="https://img.shields.io/github/repo-size/camaraproject/ReleaseTest?style=plastic"></a>
...
Sandbox API Repository to describe, develop, document, and test the ReleaseTest Service API(s). The repository does not yet belong to a CAMARA Sub Project.
...
Sandbox API Repository to describe, develop, document, and test the ReleaseTest Service API(s) within the Sub Project [ReleaseManagement](https://lf-camaraproject.atlassian.net/wiki/x/VA7e).
...
Incubating API Repository to evolve and maintain the definitions and documentation of ReleaseTest Service API(s) within the Sub Project [ReleaseManagement](https://lf-camaraproject.atlassian.net/wiki/x/VA7e)
...
* Service API(s) “ReleaseTest” (see APIBacklog.md) 
